...
class DataTransformation:
    ...
    def get_data_transformer_object(self):
        ...
        try:
            ...
            logging.info(f"Numerical features are {numerical_columns} and categorical are {categorical_columns}")
    ...
    def initate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info("Applying preprocessing obeject on training df and testing df")
